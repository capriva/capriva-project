 ...
 * The Capriva developers 2011-2017
 */
    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("Capriva") + " - " + tr("Wallet"));
...
#ifndef Q_OS_MAC
    QApplication::setWindowIcon(QIcon(":icons/Capriva"));
    setWindowIcon(QIcon(":icons/Capriva"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Capriva address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/Capriva"), tr("&About Capriva"), this);
    aboutAction->setStatusTip(tr("Show information about Capriva"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Capriva"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/Capriva"), tr("&Show / Hide"), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Capriva addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Capriva addresses"));

    openRPCConsoleAction = new QAction(QIcon(":/icons/debugwindow"), tr("&Debug window"), this);
    openRPCConsoleAction->setStatusTip(tr("Open debugging and diagnostic console"));

    openChatroomAction = new QAction(QIcon(":/icons/Capriva"), tr("&Chatroom"), this);
    openChatroomAction->setStatusTip(tr("Open https://Capriva.chat in a web browser."));

    openForumAction = new QAction(QIcon(":/icons/Capriva"), tr("&Forum"), this);
    openForumAction->setStatusTip(tr("Open https://talk.Capriva.net in a web browser."));
...
#ifndef Q_OS_MAC
            QApplication::setWindowIcon(QIcon(":icons/Capriva_testnet"));
            setWindowIcon(QIcon(":icons/Capriva_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/Capriva_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Capriva client"));
...
void BitcoinGUI::openChatroom() {
    QDesktopServices::openUrl(QUrl("https://Capriva.chat"));
}

void BitcoinGUI::openForum() {
    QDesktopServices::openUrl(QUrl("https://talk.Capriva.net"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Capriva network", "", count));
}
...
{
    QString strTitle = tr("Capriva"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Capriva address or malformed URI parameters."),
